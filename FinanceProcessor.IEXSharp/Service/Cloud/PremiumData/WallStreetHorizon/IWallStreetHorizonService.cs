...
using FinanceProcessor.IEXSharp.Model.PremiumData.WallStreetHorizon.Response;

namespace FinanceProcessor.IEXSharp.Service.Cloud.PremiumData.WallStreetHorizon
{
