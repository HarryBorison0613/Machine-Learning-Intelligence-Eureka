...
namespace FinanceProcessor.IEXSharp.Service.Cloud.CoreData.CorporateActions
{
	public interface ICorporateActionsService
	{
		...
		/// <summary>
		/// <see cref="https://iexcloud.io/docs/api/#dividends-forecast-alpha"/>
		/// Only available to paid plans.
		/// </summary>
		/// <param name="symbol"></param>
		/// <returns></returns>
		Task<IEXResponse<IEnumerable<DividendForecastResponse>>> DividendsForecastAsync(string symbol);
	}
}
