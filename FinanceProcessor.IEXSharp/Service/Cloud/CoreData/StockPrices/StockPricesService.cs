...
namespace FinanceProcessor.IEXSharp.Service.Cloud.CoreData.StockPrices
{
	public class StockPricesService : IStockPricesService
	{
		...
		public async Task<IEXResponse<IEnumerable<IntradayPriceResponse>>> HistoricalPriceByDateAsync(string symbol,
			DateTime date, bool chartByDay, QueryStringBuilder qsb = null)
		{
			...
			return await executor.ExecuteAsync<IEnumerable<IntradayPriceResponse>>(urlPattern, pathNvc, qsb: qsb);
		}
